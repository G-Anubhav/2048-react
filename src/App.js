  ...
  return (
    <div className="App">
      ...
      >
        ...
        {/* <div style={{ width: "inherit", fontFamily: "sans-serif"}}> */}
        <div style={style.newText}>
          <p class="game-explanation">
            <strong class="important">How to play:</strong> Use your{" "}
            <strong>arrow keys</strong> to move the tiles. When two tiles with
            the same number touch, they <strong>merge into one!</strong> Add them up to reach 2048!
          </p>
        </div>
      </div>
      <Footer/>
